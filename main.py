...
from etl.query import run_clientes_rentables, create_view
...
def main():
    ...
    # Normaliza fecha para unir con dim_fecha
    ...
    # Enlaza con dim_riesgo_crediticio usando reporte, monto y tiempo
